# Generated by Django 5.2.9 on 2026-01-12 03:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('announcement_type', models.CharField(choices=[('system', '系统公告'), ('activity', '活动公告'), ('update', '更新公告'), ('important', '重要通知'), ('general', '一般通知')], default='system', max_length=20, verbose_name='公告类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message_type', models.CharField(choices=[('text', '文本'), ('image', '图片'), ('file', '文件'), ('location', '位置'), ('system', '系统消息')], default='text', max_length=20, verbose_name='消息类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order_no', models.CharField(default=uuid.uuid4, max_length=50, unique=True, verbose_name='订单编号')),
                ...
                ('payment_status', models.CharField(choices=[('pending', '待支付'), ('paid', '已支付'), ('refunded', '已退款'), ('cancelled', '已取消')], default='pending', max_length=20, verbose_name='支付状态')),
                ('pickup_location', models.CharField(blank=True, max_length=200, verbose_name='取件地点')),
                ('delivery_location', models.CharField(blank=True, max_length=200, verbose_name='送达地点')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('order', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='review', to='api.order', verbose_name='订单')),
                ('rider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='received_reviews', to=settings.AUTH_USER_MODEL, verbose_name='被评价骑手')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wechat_avatar', models.URLField(blank=True, max_length=500, verbose_name='微信头像')),
                ('wechat_unionid', models.CharField(blank=True, max_length=100, null=True, unique=True, verbose_name='微信UnionID')),
                ('login_type', models.CharField(choices=[('wechat', '微信登录'), ('phone', '手机号登录'), ('account', '账号登录'), ('quick', '快速登录')], default='wechat', max_length=10, verbose_name='登录方式')),
                ('phone', models.CharField(blank=True, default='', max_length=11, verbose_name='绑定手机号')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['openid'], name='api_wechats_openid_ad5abb_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='order',
        ...
        migrations.AddIndex(
            model_name='order',
            index=models.Index(fields=['rider', 'status'], name='api_order_rider_i_17f5b6_idx'),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['openid'], name='api_userpro_openid_dbc3cd_idx'),
        ),
        migrations.AddIndex(
            model_name='userprofile',
            index=models.Index(fields=['phone'], name='api_userpro_phone_e34b3a_idx'),
        ),
        migrations.AddIndex(
            model_name='userprofile',
            index=models.Index(fields=['student_id'], name='api_userpro_student_0655ae_idx'),
        ),
        migrations.AddIndex(
            model_name='userprofile',
            index=models.Index(fields=['is_online'], name='api_userpro_is_onli_dcf920_idx'),
        ),
        migrations.AddIndex(
            model_name='userprofile',
            index=models.Index(fields=['is_rider'], name='api_userpro_is_ride_ae4731_idx'),
        ),
    ]
